...
exports.execute = async (client, message, args) => {
  ...
  if (!isBalanceEnough) return message.reply("Your balance is insufficient. You need <:Khoin:914348384326930452> "+hasItem.cost+" to buy this item.");
  ...
  return message.channel.send(`You purchased **${item}** for <:Khoin:914348384326930452> ${hasItem.cost} Khoins`);
};
